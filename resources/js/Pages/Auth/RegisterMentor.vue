<template>
    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            ...
            <jet-input id="name" type="hidden" class="mt-1 block w-full" v-model="form.role" value="mentor" required autofocus autocomplete="name" />
            ...
            <div class="mt-4">
                ...
                <select id="country" v-model="form.qualification" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full">
                    <option value=""> Select Highest Qualification </option>
                    <option v-for="qualification,index in qualifications" :value="qualification.id" :key="index"> {{qualification.name}} </option>
                </select>
            </div>
...
<script>
    ...
    export default defineComponent({
        ...
        props:['nationalities', 'qualifications'],
        methods: {
            submit() {
