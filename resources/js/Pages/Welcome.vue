    ...
    <!-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <template v-else>
                ...
                <Link v-if="canRegister" :href="route('register')+'?role=mentor'" class="ml-4 text-sm text-gray-700 underline">
                    Register as Mentor
                </Link>
                <Link v-if="canRegister" :href="route('register')+'?role=mentee'" class="ml-4 text-sm text-gray-700 underline">
                    Register as Mentee
                </Link>
            </template>
        </div>
